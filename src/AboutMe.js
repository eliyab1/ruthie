...
export default function AboutMe() {
   ...
   <br />
    <h3>I am a licensed Marriage and Family Therapist and Professional Clinical Counselor,  practicing therapy since 2013. I completed 
        ...
        work. I welcome people with situations from the most straightforward to the most unusual.</h3>
    ...
    therapy room as much as the difficult emotions.  My goal is to provide you with therapy that is focused, effective, and also fun. To 
    do this, we orient therapy around 3 pillars: emotional and cognitive processing, practical skill-building, and integrating therapy 
    material into your daily life. We use a variety of techniques, depending on 
