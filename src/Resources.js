...
export default function Resources() {
    ...
    return <div className="page-content"><h2><u>Helpful Resources For Pregnancy and Postpartum</u></h2>
                <div className="resources">
                    ...
                    <h3>Las Madres. Support for moms based on baby’s year of birth. Also has working moms group.</h3> <a href="http://www.lasmadres.com" rel="noreferrer" target="_blank">http://www.lasmadres.com</a><br />
